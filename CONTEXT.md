...
- **Export**: the act of rendering a session's active branch (plus metadata) into a conversation note. Runs automatically at session end and on demand via `/export-obsidian`.
